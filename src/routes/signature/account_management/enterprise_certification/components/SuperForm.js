...
import Control, {getTitle, makeString} from '../../../../../components/Control';
import {Icon, Form, Row, Col,Checkbox,Button} from 'antd';
  ...
  toCol = (span, control) => {
    ...
    return (
      <Col span={span * factor} key={control.key}>
        ...
        {control.btn && !readonly&& <Button className={s.formBtn}
                                onClick={onClick.bind(this,control.btn.key)}
        >{control.btn.title}</Button>}
      </Col>
    );
  };
