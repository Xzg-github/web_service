...
import showUpload from './UploadDialogContainer';



const action = new Action(['template_management'], false);
const URL_CONFIG = '/api/signature/file_management/template_management/config';
const URL_LIST = '/api/signature/file_management/template_management/list';

const getSelfState = (state) => {
  return state.template_management || {};
};
...
const addActionCreator = () => async (dispatch, getState) => {
  ...
  if (await showUpload(editConfig, {} ,false)) {
