...
const action = new Action(['enterprise_staff'], false);
const URL_CONFIG = '/api/signature/file_management/enterprise_staff/config';
const URL_LIST = '/api/signature/file_management/enterprise_staff/list';

const getSelfState = (state) => {
  return state.enterprise_staff || {};
};
