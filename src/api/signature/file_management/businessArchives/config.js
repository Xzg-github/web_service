...
const businessInfo = [
  ...
  {key: 'businessName', title: '企业名称', type: 'text', required: true, placeholder: '请填写营业执照上的名称'},
  {key: 'OCC', title: '组织代码机构证/统一社会信用代码', type: 'text', required: true, placeholder: '请输入9位组织机构证代码或18位统一社会信用代码'},
  {key: 'BLRN', title: '营业执照注册号/统一社会信用代码', type: 'text', required: true, placeholder: '请输入16位营业执照注册号或18位统一社会信用代码'},
  {key: 'bankAccount', title: '对公银行账号', type: 'text', required: true},
  {key: 'bankName', title: '对公银行名称', type: 'text', required: true},
  {key: 'branchBankName', title: '对公开户支行', type: 'text', required: true, placeholder: '请填写完整的支行名称'}
];

//管理人信息表单配置
const managerInfo = [
  {key: 'corporateResName', title: '法人代表姓名', type: 'text', required: true, placeholder: '请填写与执照上一致的法定代表人姓名'},
  {key: 'corporateResId', title: '法人代表身份证号', type: 'text', required: true, placeholder: '请填写与执照上一致的法定代表人身份证号码'},
  {key: 'accountManagerName', title: '账号管理人姓名', type: 'text', required: true},
  {key: 'accountManagerId', title: '账号管理人身份证号', type: 'text', required: true}
];
...
const businessInfoUpload = [
  {key: 'BLRN', title: '营业执照/多合一营业执照'},
  {key: 'OCC', title: '组织代码机构证/多合一营业执照'},
  {key: 'apply', title: '按要求上传申请表'}
];

const managerInfoUpload = [
  {key: 'corporateRes', title: '法定代表人身份证正反面复印件'},
  {key: 'accountManager', title: '账号管理人身份证正反面复印件'}
];
