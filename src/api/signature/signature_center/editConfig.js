...
const controls1 = [
  { key: 'associatedFileTheme', title: '模板类型', type: 'text', span: 2},
  { key: 'insertTimeEnd', title: '签署截止时间', type: 'date'},
  { key: 'remarks', title: '备注', type: 'textArea', span: 4},
];

const controls2 = [
  { key: 'method', title: '签署方式', type: 'select', options: isOptions},
  { key: 'sequence', title: '签署顺序',  type: 'select', options: isOptions, required: true},
  { key: 'position', title: '指定签署位置', type: 'select', options: isOptions},
  { key: 'copy', title: '添加抄送方', type: 'select',options: isOptions}
];
